...
namespace RentalKendaraan_101.Controllers
{
    public class PeminjamenController : Controller
    {
        ...
        public async Task<IActionResult> Index(string ktsd, string searchString, string sortOrder, string currentFilter, int? pageNumber)
        {
            ...
            var menu = from m in _context.Peminjamen.Include(k => k.IdKendaraanNavigation).Include(k => k.IdCustumerNavigation).Include(k => k.IdJaminanNavigation) select m;
            ...
            {
                case "name_desc":
                    menu = menu.OrderByDescending(s => s.IdCustumerNavigation.NamaCutumer);
                    break;
                case "Date":
                ...
                case "date_desc":
                    ...
                    break;
                default:
                    menu = menu.OrderBy(s => s.IdCustumerNavigation.NamaCutumer);
                    break;
            }
            //membuat pagedList
        ...
        {
            ViewData["IdCustumer"] = new SelectList(_context.Custumers, "IdCustumer", "IdCustumer");
        ...
        public async Task<IActionResult> Create([Bind("IdPeminjaman,TglPeminjaman,IdKendaraan,IdCustumer,IdJaminan,Biaya")] Peminjaman peminjaman)
        {
            ...
            ViewData["IdCustumer"] = new SelectList(_context.Custumers, "IdCustumer", "IdCustumer", peminjaman.IdCustumer);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPeminjaman,TglPeminjaman,IdKendaraan,IdCustumer,IdJaminan,Biaya")] Peminjaman peminjaman)
        {
